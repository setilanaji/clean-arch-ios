...
class NewestSectionTableViewCell: UITableViewCell {
    ...
    private let titleLabel: UILabel = {
        ...
        label.textColor = UIColor(named: "Black-80")
        label.font = UIFont(name: "SolusiSans-SemiBold", size: 16)
        return label
    }()
